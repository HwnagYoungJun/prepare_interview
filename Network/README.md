...
- TCP/IP 계층
  ...
  | OSI                    | TCP/IP               | 기능                                                         |
  | ---------------------- | -------------------- | ------------------------------------------------------------ |
  | 응용, 표현, 세션 계층  | 응용 계층            | 1. 응용 프로그램 간 데이터 송/수신 2. Telnet, FTP, SMTP, HTTP, DNS 등 |
  | 전송 계층              | 전송 계층            | 1. 호스트 간 통신 2. TCP, UDP                                |
  | 네트워크 계층          | 인터넷 계층          | 1. 전송 주소 지정 2. IP                                      |
  | 데이터 링크, 물리 계층 | 네트워크 액세스 계층 | 1. 실제 데이터를 송/수신 2. Ethernet, IEEE 802               |
